...
{
		private MathWritingHandler writingHandler;
		...
		void Start ()
		{
				...
				if (letters != null)
						writingHandler = letters.GetComponent<MathWritingHandler> ();
		}
		...
		public void LoadLetter (Object ob)
		{
				...
				MathWritingHandler.currentLetterIndex = int.Parse (ob.name.Split ('-') [1]);
				Application.LoadLevel ("MathAlphabetWriting");
		}
	...
	public void LoadAlphabetMenu(Object ob){
		Application.LoadLevel ("MathAlphabetMenu");
	}
}