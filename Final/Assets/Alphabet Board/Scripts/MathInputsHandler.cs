...
/// </summary>
[RequireComponent(typeof(MathEvents))]
public class MathInputsHandler : MonoBehaviour
{
		public Camera cam;
		...
		void Start ()
		{
				...
				EngEvents eventsComp = GetComponent<EngEvents> ();
				if (eventsComp == null) {//add Events component if it's missed
						gameObject.AddComponent<EngEvents> ();
				}
		}
		...
		private void ScreenClickHandle (GameObject ob, bool isTouchBegain)
		{
				...
				foreach (GameObject btn in buttons) {
						...
						MathButton btnComp = btn.GetComponent<MathButton> ();
						if (btnComp == null) {
								continue;
						}
		...
		private void ScreenClickEndedHandle ()
		{
				...
				MathButton btnComp = lastClickedBtn.GetComponent<MathButton> ();
				if (btnComp == null) {
						return;
				}
