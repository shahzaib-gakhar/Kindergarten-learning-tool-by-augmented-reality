...
/// </summary>
[RequireComponent(typeof(EngEvents))]
public class EngInputsHandler : MonoBehaviour
{
		public Camera cam;
		...
		private void ScreenClickHandle (GameObject ob, bool isTouchBegain)
		{
				...
				foreach (GameObject btn in buttons) {
						...
						EngButton btnComp = btn.GetComponent<EngButton> ();
						if (btnComp == null) {
								continue;
						}
		...
		private void ScreenClickEndedHandle ()
		{
				...
				EngButton btnComp = lastClickedBtn.GetComponent<EngButton> ();
				if (btnComp == null) {
						return;
				}
